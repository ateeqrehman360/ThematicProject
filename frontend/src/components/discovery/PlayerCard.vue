<template>
  ...
  >
    <div class="flex items-start gap-3 mb-4">
      <img :src="player.avatarUrl" :alt="player.fullName" class="w-12 h-12 rounded-full object-cover flex-shrink-0" />
      <div class="flex-1 min-w-0">
        <h3 class="font-semibold text-gray-900 truncate">{{ player.fullName }}</h3>
